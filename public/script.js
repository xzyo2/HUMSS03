...
// UPDATED BIRTHDAY DATA (Mapped to new names)
const BIRTHDAY_DATA = [
...
// ... (Keep 'phrases' and 'Global State' and 'Init' as they were) ...

// ================= BIRTHDAY LOGIC (UPDATED) =================
...
function loadBirthdays() {
    ...
    processedBirthdays.forEach((b, index) => {
        // Special logic: If no data, force standard rank styling
        ...
        // Only show Big Layouts if they actually have data
