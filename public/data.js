...
// BIRTHDAY DATA (Updated with new dates)
const BIRTHDAY_DATA = [
    ...
    { name: "DUGOS, DENISE", date: "04-24" }, // NEW
    ...
    { name: "DAÑAS, PRINCESS ANDREA", date: "05-28" }, // NEW
    ...
    { name: "PANGANIBAN, KIM RAIZA", date: "08-04" }, // CONFIRMED
